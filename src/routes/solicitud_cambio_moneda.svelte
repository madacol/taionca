<script>
	...
	function create_request_exchange_currency(){
		alert("It works");
	}

</script>

<TextInput type="number" labelText="Monto necesitado" placeholder="Ingrese el monto..." bind:value={amount}/>
...
<Button on:click={create_request_exchange_currency}>Enviar</Button>